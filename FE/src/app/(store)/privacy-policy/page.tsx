        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <article className="space-y-12 text-sm sm:text-base text-[var(--espresso-mid)] font-light leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p>
                Thông tin tài khoản, giỏ hàng và đơn hàng được xử lý qua máy chủ. Trình duyệt sử dụng cookie phiên HttpOnly để duy trì đăng nhập; dữ liệu nghiệp vụ và thông tin xác thực không được lưu trong localStorage hoặc sessionStorage.
              </p>
            </section>
