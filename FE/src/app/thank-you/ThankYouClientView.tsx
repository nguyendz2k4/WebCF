...
export const ThankYouClientView: React.FC = () => {
  const searchParams = useSearchParams();
  const orderId = searchParams.get('orderId');

  // Gating: If user directly navigates without any orderId context
  if (!orderId) {
    return (
  ...
  // Valid order context: Honest acknowledgement of order request reception
  return (
    <div className="max-w-xl mx-auto py-12 px-4 space-y-8 text-center animate-in fade-in duration-300">
      ...
      {/* Order Status Notice (Gating: Transparent that manual/staff confirmation is required) */}
